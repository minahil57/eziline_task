...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<PhaseService>(onMissingStub: OnMissingStub.returnDefault),
...
MockPhaseService getAndRegisterPhaseService() {
  _removeRegistrationIfExists<PhaseService>();
  final service = MockPhaseService();
  locator.registerSingleton<PhaseService>(service);
  return service;
}
